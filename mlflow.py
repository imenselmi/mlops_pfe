...
class Pipeline:
    ...
    def _runner(self):
        ...
        if boxes and self.save_images:
            ...
            mlflow.log_metric("pred_frame",pred_frame)
...
def main():
    ...
    model = onnx.load("/home/mj/Desktop/PFE/server/docs/examples/model_repository/yolov5/1/model.onnx")
    #mlflow.onnx.log_model(model, "yolov5", registered_model_name="onnx_float32_int32_int32")
